...
const environment = async () => {
  ...
  // console.log(student);
  // student.courses.push({ course: { datos: '63d1c7c3cb76fb0dd617c9a6', quantity: 1 } })
  // const newStudent = await studentModel.updateOne({ first_name: 'Martin'}, student);
  // console.log(newStudent)

  const student = await studentModel.findOne({ first_name: 'Martin' });
  console.log(student);
  const course = student.courses.find((course) => course.course._id == '63dd97134946917d173dbb8e')
  console.log(course) 
  // const newStudent = await studentModel.updateOne({ first_name: 'Martin'}, student);
  // console.log(newStudent)
